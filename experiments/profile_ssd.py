...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", choices=["sync1", "async1", "async3"], required=True)
    ...
    parser.add_argument("--output-dir", default="/tmp/nano_vllm_traces")
    ...
    if args.mode == "sync1":
        ...
        profile("sync_mtp_k1", sp=sp, llm=llm, prompts=prompts, output_dir=".")
        ...
        profile(f"async_ssd_k{k}", sp=sp, llm=llm, prompts=prompts, output_dir=".")
